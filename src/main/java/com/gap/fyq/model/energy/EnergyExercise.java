...
@Entity
@Table(name = "energy_exercises")
@Getter
@Setter
@NoArgsConstructor
public class EnergyExercise extends Exercise {
    ...
    /** Unidad de la respuesta mostrada junto al campo de entrada (p.ej. "J", "W", "N"). */
    @Column(length = 30)
    ...
    /** Variable incógnita del ejercicio (p.ej. "trabajo", "potencia", "altura"). */
    @Column(length = 30)
