package com.gap.fyq.model.fourtheso.scientificactivity;
...
@Entity
@Table(name = "fourth_eso_scientific_activity_exercises")
@Getter
@Setter
@NoArgsConstructor
public class FourthEsoScientificActivityExercise extends Exercise {

    @Enumerated(EnumType.STRING)
    @Column(nullable = false, length = 30)
    private FourthEsoActivityType activityType;
    ...
    /** Unidad de la respuesta (p.ej. "N", "m/s", ""); vacío para conteos enteros. */
    @Column(length = 30)
    ...
    /** Variable incógnita (p.ej. "modulo_resultante", "cifras_significativas"). */
    @Column(length = 30)
