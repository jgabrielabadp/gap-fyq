package com.gap.fyq.model.changes;
...
@Entity
@Table(name = "chemical_changes_exercises")
@Getter
@Setter
@NoArgsConstructor
public class ChemicalChangesExercise extends Exercise {

    @Enumerated(EnumType.STRING)
    @Column(nullable = false, length = 25)
    private ChemicalChangesVariant variant;
    ...
    /** Justificación pedagógica mostrada al alumno tras responder. */
